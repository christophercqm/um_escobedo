...
<p style="text-align: center">
    Se ha recibido un nuevo mensaje desde el formulario de contacto. A continuación se presentan los detalles:
</p>
...
<table class="data-table" style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #ddd; padding: 10px;">{{ $data['apellidos'] }}</td>
        </tr>
        <tr>
