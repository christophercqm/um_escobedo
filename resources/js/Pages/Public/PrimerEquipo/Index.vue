            ...
            <div class="container max-width padding-container">
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="row row-2 my-4">
                            <div class="col d-flex justify-content-start gap-3 flex-wrap">
                                <button class="btn" :class="{ 'btn-active': currentSection === 'todos' }" @click="showSection('todos')">
                                    Todos
                                </button>
                                <button class="btn" :class="{ 'btn-active': currentSection === 'portero' }" @click="showSection('portero')">
                                    Portero
                                </button>
                                <button class="btn" :class="{ 'btn-active': currentSection === 'defensa' }" @click="showSection('defensa')">
                                    Defensa
                                </button>
                                <button class="btn" :class="{ 'btn-active': currentSection === 'centrocampista' }" @click="showSection('centrocampista')">
                                    Centrocampista
                                </button>
                                <button class="btn" :class="{ 'btn-active': currentSection === 'delantero' }" @click="showSection('delantero')">
                                    Delantero
                                </button>
                            </div>
                        </div>
                        ...
                        <transition name="fade" mode="out-in">
                            <div class="container-jugadores row" key="jugadores-list">
                                <div v-for="jugador in displayedJugadores" :key="jugador.id" class="jugador-card col-md-6 mb-4 fade-in">
                                    <div class="card text-center">
                                        <div class="img-player">
                                            <img :src="`/storage/${jugador.foto_url}`" alt="Foto de {{ jugador.nombre }}" class="card-img-top card-img-jugador" />
                                        </div>
                                        <div class="card-body">
                ...
                <div class="row row-2 row-cuerpo-tecnico justify-content-md-between">
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="row">
                            <div v-for="miembro in displayedCuerpoTecnico" :key="miembro.id" class="cuerpo-tecnico-card col-md-6 mb-4">
                                <div class="card text-center">
                                    <div class="img-tecnico">
                                        <img :src="`/storage/${miembro.foto}`" alt="Foto de {{ miembro.nombres }} {{ miembro.apellidos }}" class="card-img-top card-img-tecnico" />
                                    </div>
                                    <div class="card-body">
