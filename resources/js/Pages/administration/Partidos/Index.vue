    ...
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <NavLink class="btn-admin" :href="route('partidos.create')">
                ...
                <div style="overflow-x: auto">
                    ...
                    >
                        <thead>
                            <tr>
                                <th class="sortable" data-column="equipo_local">
                                    Equipo Local
                                </th>
                                <th
                                    class="sortable"
                                    data-column="equipo_visitante"
                                >
                                    Equipo Visitante
                                </th>
                                <th class="sortable" data-column="fecha_hora">
                                    Fecha y Hora
                                </th>
                                <th class="sortable" data-column="resultado">
                                    Resultado
                                </th>
                                <th class="sortable" data-column="estado">
                                    Estado
                                </th>
                                <th class="sortable" data-column="estadio">
                                    Estadio
                                </th>
                                <!-- Nueva columna Estadio -->
                                <th class="sortable" data-column="acciones">
                                    Acciones
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="partido in partidos" :key="partido.id">
                                <td>
                                    <div class="team-info">
                                        <img
                                            v-if="partido.equipo_local"
                                            :src="`/storage/${partido.equipo_local.logo}`"
                                            alt="Logo del equipo local"
                                            class="team-logo"
                                        />
                                        <span v-if="partido.equipo_local">{{
                                ...
                                <td>
                                    <div class="team-info">
                                        <img
                                            v-if="partido.equipo_visitante"
                                            :src="`/storage/${partido.equipo_visitante.logo}`"
                                            alt="Logo del equipo visitante"
                                            class="team-logo"
                                        />
                                        <span v-if="partido.equipo_visitante">{{
                                ...
                                <td>
                                    ...
                                    >
                                    <span
                                        v-else-if="partido.estado === 'Activo'"
                                        class="text-success"
                                        >Activo</span
                                    >
                                ...
                                <td>
                                    <span v-if="partido.estadio">{{
                                        partido.estadio
                                    }}</span>
                                    <!-- Nueva celda para Estadio -->
                                    <span v-else>No disponible</span>
                                </td>
        ...
        if (isConfirmed) {
            ...
            Inertia.delete(route("partidos.destroy", id), {
                onSuccess: () => {
                    ...
                    partidos.value = partidos.value.filter(
