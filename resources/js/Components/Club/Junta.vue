...
.logos-slide {
    ...
    animation: slide 35s infinite linear; /* Duración por defecto */
}
...
@media (max-width: 600px) {
    ...
    .logos-slide {
        animation: slide 25s infinite linear; /* Ajuste de duración para pantallas pequeñas */
    }
}

@media (max-width: 768px) {
    .logos-slide {
        animation: slide 30s infinite linear; /* Ajuste de duración para pantallas medianas */
    }
